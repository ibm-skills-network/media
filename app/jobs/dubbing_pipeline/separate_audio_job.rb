class DubbingPipeline::SeparateAudioJob < ApplicationJob
  queue_as :gpu

  sidekiq_retries_exhausted do |msg, exceptoin|
  ...
  def perform(task_id)
    ...
    _stdout, stderr, status = Open3.capture3{
      "python3", Rails.root.join("script/dubbing/seperate_audio.py").to_s,
      task.audio_path,
