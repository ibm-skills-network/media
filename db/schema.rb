...
ActiveRecord::Schema[8.0].define(version: 2025_10_17_195357) do
  ...
  create_table "videos_qualities_transcoding_profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["video_quality_id"], name: "idx_on_video_quality_id_116fc13a94"
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "videos_qualities", "videos"
  add_foreign_key "videos_qualities_transcoding_profiles", "videos_qualities", column: "video_quality_id"
end
